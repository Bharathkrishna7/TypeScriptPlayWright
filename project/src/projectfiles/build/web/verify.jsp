...
<html lang="en">
        ...
        <nav class="navbar navbar-expand-md bg-dark navbar-dark sticky-top">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link font-weight-bolder active" href="verify.jsp">
    ...
    <center>
        <%
             ...
             PreparedStatement pst=con.prepareStatement("select * from verify where status='Cloud Done'");    
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="verification.jsp?id=<%=rs.getString(1)%>&fname=<%=rs.getString(3)%>&owner=<%=rs.getString(2)%>&hkey=<%=rs.getString(5)%>&oname=<%=rs.getString(5)%>"><button class="btn-hover color-1" style="text-decoration: none;font-family:Andalus, sans-serif;color:black;font-size: 15px;width:90px;height: 30px;" id="n" onclick="change()">
                                        Verify
                                    </button></a></td>
                        </tr>
                        <%}%>
