...
<html lang="en">
        ...
        <nav class="navbar navbar-expand-md bg-dark navbar-dark sticky-top">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link font-weight-bolder active" href="u_viewfiles.jsp">
    ...
    <center>
        <%
             ...
             PreparedStatement pst=con.prepareStatement("select * from upload where status='Verified'");    
        ...
        <div class="container"> 
          ...
          while(rs.next())  {      
                        ...
                        <tr>
                            ...
                            <td><a href="userrequest.jsp?id=<%=rs.getString(1)%>&owner=<%=rs.getString(3)%>&fname=<%=rs.getString(4)%>&skey=<%=rs.getString(7)%>"><button class="btn-hover color-1" style="text-decoration: none;font-family:Andalus, sans-serif;color:black;font-size: 15px;width:90px;height: 30px;" id="n" onclick="change()">
                                        Request
                                    </button></a></td>
                        </tr>
                        <%}%>
