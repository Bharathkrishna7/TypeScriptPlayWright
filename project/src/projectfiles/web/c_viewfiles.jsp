        ...
        <nav class="navbar navbar-expand-md bg-dark navbar-dark sticky-top">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link font-weight-bolder active" href="c_viewfiles.jsp">
                            <i class="fas fa-file"></i> View Files</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link font-weight-bolder" href="c_viewrequest.jsp">
...
while(rs.next())  {      
                        ...
                        <tr>
                            ...
                            <td><textarea readonly=""><%=rs.getString(5)%></textarea></td>
                        </tr>
                        <%}%>
                    </tbody>
                </table>
